  ...
  <div>
    <section class="my-32 max-w-6xl mx-auto px-4 sm:px-6">
      <div class="max-w-xl mx-auto">
        <h3 class="text-center text-primary-yellow">
        ...
        <form action="" class="space-y-10">
          <div class="flex">
            <div class="w-1/2">
              <label
                for="investor"
                class="text-base font-normal font-source-sans"
              >
          ...
          <div class=" w-full">
            ...
            <div>
              <textarea id="message" placeholder="Type here..." class=" h-40 border border-gray-700 rounded-lg px-4 py-2 text-sm font-normal w-full mt-2">
